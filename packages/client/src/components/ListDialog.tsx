...
import { Button, ClickAwayListener, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Input, Link, MenuItem, OutlinedInput, Select, TextField, Tooltip } from '@mui/material'
...
function ListDialog(props: ListDialogProps) {
    ...
    >
      <DialogTitle>
        <Trans i18nKey="List Dialog Title">
          List
          <CountryFlag find={props.data.tick} />
          for sale
        </Trans>
      </DialogTitle>
          ...
          <div className="mt-10 mb-14">
            <div className="flex flex-col gap-3 max-w-80 mr-8 md:mx-auto">
              ...
              <div className="relative">
                ...
                />
                <ListDialogFill onFill={onFillLimit} />
              </div>
            </div>
